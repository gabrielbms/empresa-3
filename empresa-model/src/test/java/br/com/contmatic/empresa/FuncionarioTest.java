...
public class FuncionarioTest {
	...
	public void nao_deve_aceitar_telefone_vazio() {
		...
		assertFalse(isValid(funcionario, "A lista de telefone da empresa não deve ser vazio."));
	}
...
//		assertFalse(isValid(funcionario, "A lista de telefone do funcionário mínima é de 1."));
//	}
