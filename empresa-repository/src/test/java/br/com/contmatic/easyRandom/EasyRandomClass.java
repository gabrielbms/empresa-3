...
public class EasyRandomClass {
    ...
    public Cliente clienteRandomizer() {
        ...
        cliente.setBoleto(Geradores.generateRandomBigDecimalValueFromRange(BigDecimal.valueOf(10.00), BigDecimal.valueOf(500.00).setScale(1)));
        return cliente;
    }
    ...
    public Empresa empresaRandomizer() {
        ...
        empresa.setSite("www." + nomeEmpresa.toLowerCase().replace(" ", "").replace("'", "").replace(",", "").replace("-", "") + 
            ".com.br");
