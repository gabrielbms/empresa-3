...
public class ClienteResourceAssemblyTest {
    ...
    public void deve_transformar_uma_classe_cliente_em_document() {
        ...
        assertThat(clienteUTF8.replace(".00", ".0").replace(".10", ".1").replace(".20", ".2").replace(".30", ".3").replace(".40", ".4")
            .replace(".50", ".5").replace(".60", ".6").replace(".70", ".7").replace(".80", ".8").replace(".90", ".9"),
